...
def is_winner(current_row_index, current_col_index, board):
    for direction, cords in DIRECTION_MAPPER.items():
        ...
        travel_opposite_direction_count = travel_direction(cords, current_row_index, current_col_index, searched_element, "-", board)
